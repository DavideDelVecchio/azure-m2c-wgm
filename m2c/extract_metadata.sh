...
# format: python main.py extract_db_metadata <db-url> <db-name>

source env.sh

python main.py extract_db_metadata $M2C_SOURCE_MONGODB_URL olympics

python main.py extract_db_metadata $M2C_SOURCE_MONGODB_URL openflights
