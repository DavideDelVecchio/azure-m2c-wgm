...
# 1) Downloads blob openflights__airlines__source.json from container openflights-raw
#    to local file tmp/openflights/openflights__airlines__source.json
...
python wrangle.py transform_blob \
    ...
    --out-container openflights-adf  # > out/openflights/wrangle_openflights__airlines__source.json.out

echo 'first line of input file:' # > out/openflights/wrangle_openflights__airlines__source.json.out
head -1 tmp/openflights/openflights__airlines__source.json # > out/openflights/wrangle_openflights__airlines__source.json.out

echo 'first line of output file:' # > out/openflights/wrangle_openflights__airlines__source.json.out
head -1 tmp/openflights/openflights__airlines__wrangled.json # > out/openflights/wrangle_openflights__airlines__source.json.out

echo 'deleting downloaded and wrangled files ...'
rm tmp/openflights/openflights__airlines__source.json
