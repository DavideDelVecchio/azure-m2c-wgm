...
# 1) Downloads blob olympics__g1948_winter__source.json from container olympics-raw
#    to local file tmp/olympics/olympics__g1948_winter__source.json
# 2) Wrangle/transform the downloaded blob, producing local file 
#    tmp/olympics/olympics__g1948_winter__wrangled.json
...
head -1 tmp/olympics/olympics__g1948_winter__source.json

echo ''
echo 'first line of output file:'
head -1 tmp/olympics/olympics__g1948_winter__wrangled.json
...
# rm tmp/olympics/olympics__g1948_winter__wrangled.json
