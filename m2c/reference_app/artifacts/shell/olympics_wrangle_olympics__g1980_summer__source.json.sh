...
python wrangle.py transform_blob \
    ...
    --out-container olympics-adf  # > out/olympics/wrangle_olympics__g1980_summer__source.json.out

echo 'first line of input file:' # > out/olympics/wrangle_olympics__g1980_summer__source.json.out
head -1 tmp/olympics/olympics__g1980_summer__source.json # > out/olympics/wrangle_olympics__g1980_summer__source.json.out

echo 'first line of output file:' # > out/olympics/wrangle_olympics__g1980_summer__source.json.out
head -1 tmp/olympics/olympics__g1980_summer__wrangled.json # > out/olympics/wrangle_olympics__g1980_summer__source.json.out
