...
# 1) Downloads blob openflights__airports__source.json from container openflights-raw
#    to local file tmp/openflights/openflights__airports__source.json
# 2) Wrangle/transform the downloaded blob, producing local file 
#    tmp/openflights/openflights__airports__wrangled.json
...
python wrangle.py transform_blob \
    ...
    --out-container openflights-adf  # > out/openflights/wrangle_openflights__airports__source.json.out

echo 'first line of input file:' # > out/openflights/wrangle_openflights__airports__source.json.out
head -1 tmp/openflights/openflights__airports__source.json # > out/openflights/wrangle_openflights__airports__source.json.out

echo 'first line of output file:' # > out/openflights/wrangle_openflights__airports__source.json.out
head -1 tmp/openflights/openflights__airports__wrangled.json # > out/openflights/wrangle_openflights__airports__source.json.out

echo 'deleting downloaded and wrangled files ...'
rm tmp/openflights/openflights__airports__source.json
