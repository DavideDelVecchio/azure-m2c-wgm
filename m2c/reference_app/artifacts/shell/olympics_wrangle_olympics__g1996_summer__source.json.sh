...
# 1) Downloads blob olympics__g1996_summer__source.json from container olympics-raw
#    to local file tmp/olympics/olympics__g1996_summer__source.json
...
python wrangle.py transform_blob \
    ...
    --filename tmp/olympics/olympics__g1996_summer__source.json \
    --outfile  tmp/olympics/olympics__g1996_summer__wrangled.json \
    --out-container olympics-adf  # > out/olympics/wrangle_olympics__g1996_summer__source.json.out

echo 'first line of input file:' # > out/olympics/wrangle_olympics__g1996_summer__source.json.out
head -1 tmp/olympics/olympics__g1996_summer__source.json # > out/olympics/wrangle_olympics__g1996_summer__source.json.out

echo 'first line of output file:' # > out/olympics/wrangle_olympics__g1996_summer__source.json.out
head -1 tmp/olympics/olympics__g1996_summer__wrangled.json # > out/olympics/wrangle_olympics__g1996_summer__source.json.out

echo 'deleting downloaded and wrangled files ...'
rm tmp/olympics/olympics__g1996_summer__source.json
