...
def test_mapping_file():
    app_config = AppConfig()
    expected = '/Users/cjoakim/github/azure-m2c-wgm/reference_app/data/metadata/olympics_mapping.json'
...
def test_mongoexports_dir():
    app_config = AppConfig()
    expected = '/Users/cjoakim/github/azure-m2c-wgm/reference_app/data/olympics/mongoexports'
...
def test_mongoexports_file():
    app_config = AppConfig()
    expected = '/Users/cjoakim/github/azure-m2c-wgm/reference_app/data/olympics/mongoexports/olympics__countries__source.json'
...
def test_artifact_dir():
    app_config = AppConfig()
    expected = '/Users/cjoakim/github/azure-m2c-wgm/reference_app/artifacts/shell'
