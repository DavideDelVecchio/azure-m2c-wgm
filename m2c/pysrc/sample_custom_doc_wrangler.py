...
# Class SampleCustomDocumentWrangler is an example of how customers can
# implement their own wrangling logic, similar to StandardDocumentWrangler,
# but with a few additions.  This implementation adds a "preprocess_document"
# step that translates a an epoch millisecond "timestamp" and adds the
# calculated "timestamp_year" attribute to the doc.
# 
...
class SampleCustomDocumentWrangler(object):
